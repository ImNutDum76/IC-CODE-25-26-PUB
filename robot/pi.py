...
OPERATOR_IP = "192.168.50.53" # your laptop/pc ip address on IC2026 Network
OPERATOR_PORT = 5600 # the port for video streaming 
TEAM_ID = 19 # Your team ID

PI_IP = "192.168.50.204" # Your pi IP
PI_PORT = 5005  # 
...
if __name__ == "__main__":
    team_id = TEAM_ID  # your team id here
